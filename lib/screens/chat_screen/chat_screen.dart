        ...
        return RefreshIndicator(
          ...
          child: Obx(
            () => Scaffold(
                ...
                child: SafeArea(
                  child: Container(
                    ...
                    child: AppInputWidget(
                      onTap: () {
                        if (controller.isShowSearchChatList.value == false) {
                          controller.isShowSearchChatList.value = true;
                        }
                      },
              ...
              body: controller.isShowSearchChatList.value
                  ? ListView.builder(
                      itemCount: controller.chatSearchList.length,
                      itemBuilder: (context, index) {
                        var item = controller.chatSearchList[index];
