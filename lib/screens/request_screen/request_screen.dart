          ...
          body: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(color: AppColors.black50, borderRadius: BorderRadius.circular(AppSize.width(value: 10.0))),
                child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Container(
                                      ...
                                      padding: EdgeInsets.all(AppSize.width(value: 5.0)),
                                      decoration: BoxDecoration(border: Border.all(color: AppColors.primary), borderRadius: BorderRadius.circular(AppSize.width(value: 5.0))),
                                      child: AppText(
                                        data: "Reject",
                                        color: AppColors.primary,
                                      ),
                            ...
                            if (item.status != BookingRequestEnum.request)
                              Center(
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: item.status == BookingRequestEnum.complete
                                        ? AppColors.green.withOpacity(0.45)
                                        : item.status == BookingRequestEnum.pending
                                            ? AppColors.yellow200
                                            : item.status == BookingRequestEnum.reject
                                  ...
                                  child: AppText(
                                    data: item.status == BookingRequestEnum.complete
                                        ? "Completed"
                                        : item.status == BookingRequestEnum.pending
                                            ? "Ongoing"
                                            : item.status == BookingRequestEnum.reject
