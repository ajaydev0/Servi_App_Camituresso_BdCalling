...
class AppInputWidgetChat extends StatefulWidget {
  const AppInputWidgetChat({
    super.key,
    this.hintText,
    this.prefix,
    this.suffixIcon,
  ...
  @override
  State<AppInputWidgetChat> createState() => _AppInputWidgetTwoState();
}

class _AppInputWidgetTwoState extends State<AppInputWidgetChat> {
    ...
    return Material(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          errorStyle: const TextStyle(backgroundColor: AppColors.white50),
